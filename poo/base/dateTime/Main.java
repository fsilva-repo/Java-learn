...
public class Main {
	...
	public static void main(String[] args) {
		...
		IO.println("\n----------Data e hora timezone londres----------");
		// obter data e hora timezone londres
		Instant d03 = Instant.now();
		IO.println(d03);

		// **** parsear ou (converter) de string para objeto data e hora ****

		IO.println("\n----------De String para Data local----------");
		// converte string para data
		LocalDate d04 = LocalDate.parse("2026-01-31");
		IO.println(d04);

		IO.println("\n----------De String para Data e hora local----------");
		// converte string para data e hora
		LocalDateTime d05 = LocalDateTime.parse("2026-01-31T23:45");
		IO.println(d05);

		IO.println("\n----------De String para Data e hora timezone londres----------");
		// converte de string para data e hora timezone londres
		Instant d06 = Instant.parse("2026-01-31T23:45:45Z");
		IO.println(d06);

		IO.println("\n----------De String para Data e hora timezone londres----------");
		// converte de string para data e hora timezone londres com desconto de fuso
		// horario
		Instant d07 = Instant.parse("2026-01-31T23:45:45-03:00");
		IO.println(d07);

		// **** definindo um estilo de formatacao da data e hora ****

		IO.println("\n----------Estilizando a Data local----------");
		LocalDate currentDay = LocalDate.now();
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd MMMM yyy");
		IO.println(currentDay.format(formatter)); // dd MMMM yyy para 31 Janeiro 2026
																							// dd MM yyy para 31 01 2026
																							// dd M yyy para 31 1 2026

		IO.println("\n----------Utilizando o LOCALE como formataddor de Data e hora local----------");
		DateTimeFormatter patternBR = DateTimeFormatter.ofPattern("dd 'de' MMMM 'de' yyyy", new Locale("pt", "BR"));
		LocalDate date = LocalDate.of(2026, 01, 31);
		IO.println(date.format(patternBR));
